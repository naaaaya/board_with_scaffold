class CommentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @comment.update(comment_params)
        format.html { redirect_to @my_thread, notice: 'Comment was successfully updated.' }
  ...
  def destroy
    @comment.destroy
    respond_to do |format|
      format.html { redirect_to @my_thread, notice: 'Comment was successfully destroyed.' }
  ...
  private
    ...
    def comment_params
      params.require(:comment).permit(:content).merge(my_thread_id: @my_thread.id)
    end
end
